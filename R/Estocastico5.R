...
Geracao_de_Energia_Estocastico5<-function(long,long.st,lat,A,
                                         ...
                                         AlbedoFixo=0.2,TipoAlbedo="fixo",VVFixo=1.7,TipoVV="fixo",TaFixo=25,TipoTA="fixo",modo_radiacao="ceu_limpo", ModeloSintese="Estocastico",ModeloComposicao="Orgill",
                                         TipoDeClima,TipoModulo_Montagem,DadosMensais, Precos){
  ...
  c<-CeuLimpo(A,TipoDeClima,g$theta,g$theta.z,g$HaSol, r$G.on, r$G.o)

  s<-Sintetico(g$omega.sunset,g$omega.t,g$omega.b_delta.t,
               DadosMensais, r$G.on, g$delta, g$omega.1, g$omega.2,
               lat, g$HaSol, g$tempos, ModeloComposicao, ModeloSintese, g$omega.t_delta.t, g$theta.z) # Orgill Estocastico semi-validado
  ...
  a<-Ambientais(modo_radiacao, c$G.cnb, c$G.cd, g$theta.z, r$G.o,   #K.T tem NaNs. To Do: Corrigir.
                ...
                s$Ibn, s$Id, T.Sintetico, tempos, DadosMensais)
  ...
  Valor<-ValorEnergetico(ce$E, Precos)
  Precos<-as.matrix(Precos)
