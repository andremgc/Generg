...
#geometrico <- function(lat, long, long.st, Beta, gama, passo=60, Hora_do_passo="Mais_tarde", tempo.inicial="01/01/2015 00:00", tempo.final="31/12/2015 23:00") {
geometrico <- function(lat, long, long.st, Beta, gama, passo, Hora_do_passo, tempo.inicial, tempo.final) {
