...
Geracao_de_Energia_Estocastico<-function(long,long.st,lat,A,DadosAmbientais,Pdc0,Beta,gama,TipoDePainel,pot_inv,n_inv,n_non,perdasTot,Pac0,G.sc,TempRef,IrrRef,n_ref,tempo.inicial,tempo.final,passo,Hora_do_passo,AlbedoFixo,TipoAlbedo,VVFixo,TipoVV,TaFixo,TipoTA,modo_radiacao,TipoDeClima,TipoModulo_Montagem,DadosMensais){
